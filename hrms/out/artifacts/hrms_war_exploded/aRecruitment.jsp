...
<div id="wrapper">
    <div id="header">
        ...
        <div style="float: right;margin-right: 184px;margin-top: 18px">
            ...
            <a href="page/tour/tourLogin.jsp" id="t33"><span>游客登录</span></a>
...
<div id="body2">
    ...
    <hr style="width: 1px;height: 300px;margin-left: 350px;margin-top: -129px;float: left">
    <div id="t2">
        <div style="float: left;margin-left: -50px;margin-top: -152px">
            ${info}<br/>
            <h3>工作地点</h3>
            ${recruitment.workingPlace}<br/>
            <h3>薪资</h3>${recruitment.salary}<br/>
            <h3>职位类型</h3>${recruitment.positionType}<br/>
            <h3>职位描述</h3>${recruitment.description}<br/><br/>
        </div>
        <a href="delivery?recId=${recruitment.id}" style="float: left;margin-left: 233px;margin-top: -4px;font-size: xx-large;color: black">投递</a>
    </div>
</div>
</body>
</html>
