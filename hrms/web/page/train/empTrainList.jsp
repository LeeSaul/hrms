...
<div id="m">
    ...
    <div id="t2">
        <c:choose>
            <c:when test="${not empty trainNotices}">
                <table style="text-align: center;width: 100%" cellspacing="0px" cellpadding="0px">
                    ...
                    <c:forEach items="${trainNotices}" var="trn">
                        <tr>
                            <td>${trn.train.title}</td>
                            <td>${trn.train.content}</td>
                            <td>${trn.train.startTime}</td>
                            <td>${trn.train.status}</td>
                        </tr>
                    </c:forEach>
                </table>
            </c:when>
